...
/*
1прямой обход плнять прицнип
2создаь массив из ключегий отсортированный и из негот построить дерево сбалансированнаое 
*/
...
void view_1(Tree **root, int pass)	//ssdelat ne не через указатели  а через значение 
{
	Tree *prev = NULL, *t;
	bool find = true;
	t = *root;
...
menu:
	...
	cout << "5) Вывод числа узлов имеющих 2 потомка+ " << endl;
	cout << "6) Вывод информации  ----------" << endl;
	cout << "7) Выход+ " << endl;
	cout << "8) Прямой, симметричный и обратный вывод+ " << endl;
	...
	{
		task(root);
		cout <<"Число вершин с двумя потомками: " <<kol<<endl;
		kol = 0;
		break;
	}
